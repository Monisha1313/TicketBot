...
export default function ChatWindow() {
  ...
  const { listening, supported, toggle, speak } = useVoice(handleVoiceResult);
  ...
  // Read last bot reply aloud (only short ones)
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <input
          ...
          placeholder={
            listening ? "🎙️ Listening…" : "Type or speak your message…"
          }
          style={{
            flex:         1,
            background:   "#1e1e26",
